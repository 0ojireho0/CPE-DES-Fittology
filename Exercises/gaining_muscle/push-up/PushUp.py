...
while True:
    ...
    if display_info:  # Check if to display counter, bar, and percentage
        ...
        if len(lmList) != 0:
            ...
            per_left = np.interp(leftangle, (190, 300), (100, 0)) # first parenthesis, the value threshold of the angle. Second, represents the interp value
            bar_left = np.interp(leftangle, (190, 300), (200, 400))

            per_right = np.interp(rightangle, (30, 170), (0, 100))
            bar_right = np.interp(rightangle, (30, 170), (400, 200))
    ...
    cv2.putText(img, f"{int(count)}/5", (30, 80), cv2.FONT_HERSHEY_SCRIPT_SIMPLEX, 1.6, (255, 255, 255), 7)
