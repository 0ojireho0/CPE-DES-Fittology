...
cap = cv2.VideoCapture(r'C:\Users\RID\Desktop\pose_estimation\aipose2\Exercise\weightloss\jumpinglunge.mp4')
...
while True:
    ...
    if display_info:  # Check if to display counter, bar, and percentage
        ...
        if len(lmList_jumping_jacks) != 0:
            ...
            rightleg, orientation = detector_alternatingleftlunge.JumpingLunge(img, 24, 26, 28, True)
            leftleg, orientation2 = detector_alternatingleftlunge.JumpingLunge(img, 23, 25, 27, True)
